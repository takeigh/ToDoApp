...
public class ProjectEntry extends JPanel {
    ...
    public ProjectEntry() {
        ...
        titleField.setPreferredSize(new Dimension(900, 30));
        ...
        descriptionField.setPreferredSize((new Dimension(900, 500)));
        descriptionField.setBorder(new EmptyBorder(5, 5, 10, 5));
